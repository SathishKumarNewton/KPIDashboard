...
$(function() {
    $.widget("unc.jbPivot", {
        ...
        _renderHtml: function() {
            ...
            var c = "";
            c += "<table border='0px' cellspacing='0' cellpadding='0' class='unused_fields'><tr><th class='unused_field dropable targetU0' rel='U,0'>" + this.options.l_unused_fields + "</th>";
            for (d = 0; d < this.ufields.length; d++) {
                ...
                c += " rel= 'U," + (d + 1) + "'";
                c += ">";
                c += this.fieldLabels[this.ufields[d]];
                c += "</td></tr>"
            }
            c += "</table>";
            ...
            if (this.options.copyright) {
                ...
                c += " class='" + m + "'";
                c += ">";
                c += "<a href='http://www.jbPivot.org'>jbPivot</a> by <a href='http://www.uniclau.org'> Uniclau S.L. &copy; 2013 </a> <a href='http://www.gnu.org/licenses/gpl.html'><img src='http://www.gnu.org/graphics/gplv3-88x31.png'></a>";
                c += "</tr>"
            }
            c += "</table>";
